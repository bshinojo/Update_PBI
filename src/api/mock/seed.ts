...
export function createSeedDb(): MockDb {
  ...
  const schedules: Schedule[] = [
    ...
    sched({ id: 'sch-4', datasetId: 'ds-logistica', workspaceId: 'ws-ops', tables: ['Envios'], frequency: { kind: 'weekly', daysOfWeek: [1, 3, 5], time: '07:30' }, refreshType: 'calculate', enabled: true, lastRun: { status: 'Completed', timestamp: '2026-06-04T07:30:00-03:00' } }),
    ...
    sched({ id: 'sch-6', datasetId: 'ds-tesoreria', workspaceId: 'ws-finanzas', tables: ['FlujoCaja'], frequency: { kind: 'daily', time: '08:00' }, refreshType: 'dataOnly', enabled: true, lastRun: { status: 'InProgress', timestamp: '2026-06-05T08:00:00-03:00' } }),
  ]
